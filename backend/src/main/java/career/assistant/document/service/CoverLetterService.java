...
public class CoverLetterService {
    ...
    @Transactional public CoverLetter generate(Job job){
        ...
        String body="Dear "+company+" Hiring Team,\n\nI am applying for the "+job.getTitle()+" role in the UAE. I would bring "+evidence+".\n\nMy background, employers, titles, dates, certifications, and outcomes are presented exactly as verified in my resume. I would welcome the opportunity to discuss how this verified experience aligns with your needs.\n\nSincerely,\n"+name;
