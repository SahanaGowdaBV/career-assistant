...
public class SettingsController {
 ...
 private UserSettings defaults(){UserSettings s=new UserSettings();s.setId(id());s.setOwnerSubject(subject());s.setProfileName("UAE DevOps Search");s.setLocations("Dubai,Abu Dhabi,Sharjah,Ajman,Fujairah,Ras Al Khaimah,Umm Al Quwain,Al Ain,UAE Remote");s.setRoles("DevOps Engineer,Senior DevOps Engineer,SRE,Cloud Engineer,Cloud Architect,Platform Engineer");s.setSkills("AWS,Kubernetes,Terraform,Docker,GitHub Actions,Helm,Linux,CI/CD,Grafana,Monitoring");s.setExperienceMin(4);s.setExperienceMax(8);return s;}
